...
public class AttendancePublicActivity extends AppCompatActivity implements
        SharedPreferences.OnSharedPreferenceChangeListener{

    TextView Latitude,Longitude, pTopTextView;
    TextInputLayout pTicketAmount, pFromLocation, pToLocation, pTaskDetails;
    ...
    private String TravelTypeIntent="", Msg="",uniqueNumber="", userName="", currentDate="", currentTime="", vehicleId="0";
    private String From="", To="", TaskNote="", TicketAmt="", b64_img="", mCurrentPhotoPath="", type="", mLatitude="", mLongitude="";
    private String intentFrom="", intentTo="", intentTravelType="", intentVId="", intentPrevDate="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_public);
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);    //For Location

        Msg = getIntent().getStringExtra("Msg");
        intentTravelType = getIntent().getStringExtra("TravelType");

        employee = SharedPrefLogin.getInstance(this).getUser();
        uniqueNumber = String.valueOf(employee.getUniquenumber());
        userName = employee.getName();

        pTopTextView = findViewById(R.id.public_top_text);
        pFromLocation = findViewById(R.id.public_from);
        pToLocation = findViewById(R.id.public_to);
        pTaskDetails = findViewById(R.id.public_report);
        pTicketAmount = findViewById(R.id.public_tAmt);
        pTicketImage = findViewById(R.id.public_ticket_img);
        submit = findViewById(R.id.public_button);
        ...
        if (Msg.equalsIgnoreCase("CheckIn")) {
            ...
            pTopTextView.setText("Check-In Details");
            pTaskDetails.setHint("What's your plan today");
            pTicketAmount.setVisibility(View.GONE);
            pTicketImage.setVisibility(View.GONE);
            if (intentTravelType.equalsIgnoreCase("Previous Public Transport")){
                ...
                Log.i(intentVId, intentPrevDate);
                vehicleId = intentVId;

                pFromLocation.getEditText().setText(intentFrom);
                pToLocation.getEditText().setText(intentTo);
                pFromLocation.getEditText().setText(intentFrom);
                pToLocation.getEditText().setText(intentTo);
                pFromLocation.setFocusable(false);
                pToLocation.setFocusable(false);
            ...
            pTopTextView.setText("Check-Out Ticket Details");
            pTaskDetails.setHint("Today's Report");
            pTicketAmount.setHint("Ticket Amount");
            pFromLocation.getEditText().setText(intentFrom);
            pToLocation.getEditText().setText(intentTo);
            pFromLocation.setFocusable(false);
            pToLocation.setFocusable(false);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                From = pFromLocation.getEditText().getText().toString().trim();
                To = pToLocation.getEditText().getText().toString().trim();
                TicketAmt = pTicketAmount.getEditText().getText().toString().trim();
                ...
                if (Msg.equalsIgnoreCase("CheckIn")) {
                    ...
                    if (intentTravelType.equalsIgnoreCase("Public Transport")){
                        if (TextUtils.isEmpty(From)){
                            Toast.makeText(AttendancePublicActivity.this, "Enter From Location", Toast.LENGTH_SHORT).show();
                        }else if (TextUtils.isEmpty(To)){
                            Toast.makeText(AttendancePublicActivity.this, "Enter To Location", Toast.LENGTH_SHORT).show();
                        }else if (TextUtils.isEmpty(TaskNote)){
                            Toast.makeText(AttendancePublicActivity.this, "Enter Today's Task", Toast.LENGTH_SHORT).show();
                        }else {
                            pd.show();
                            submit.setEnabled(false);
                            submit.setClickable(false);
                            mService.requestLocationUpdates();//call service
                            if (dbCheckIn.addCheckIn(Msg, vehicleId, uniqueNumber, userName, currentDate, mLatitude, mLongitude, "0", b64_img, currentTime, TaskNote, From, To, 0)) {
                                if (db.addTrackingDetail(uniqueNumber, employee.getName(), "1", mLatitude, mLongitude, currentDate, currentTime, 0)) {
                                    ...
                                    pd.dismiss();
                                    Toast.makeText(AttendancePublicActivity.this, Msg, Toast.LENGTH_SHORT).show();
                    ...
                    }else if (intentTravelType.equalsIgnoreCase("Previous Public Transport")){
                        if (TextUtils.isEmpty(From)){
                            Toast.makeText(AttendancePublicActivity.this, "Enter From Location", Toast.LENGTH_SHORT).show();
                        }else if (TextUtils.isEmpty(To)){
                            Toast.makeText(AttendancePublicActivity.this, "Enter To Location", Toast.LENGTH_SHORT).show();
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://www.arunodyafeeds.com/sales/android/NewScript/PreviousCheckout.php",
                                    new Response.Listener<String>() {
                                        ...
                                        public void onResponse(String response) {
                                            ...
                                            if (response.equalsIgnoreCase("Checked-Out")) {
                                                Toast.makeText(AttendancePublicActivity.this, response, Toast.LENGTH_SHORT).show();
                                ...
                                public void onErrorResponse(VolleyError volleyError) {
                                    ...
                                    if (volleyError instanceof NetworkError || volleyError instanceof AuthFailureError || volleyError instanceof NoConnectionError || volleyError instanceof TimeoutError) {
                                        Toast.makeText(AttendancePublicActivity.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
                            ...
                            RequestQueue rQeue = Volley.newRequestQueue(AttendancePublicActivity.this);
                    ...
                    if (TextUtils.isEmpty(From)){
                        ...
                        Toast.makeText(AttendancePublicActivity.this, "Enter Today's Task", Toast.LENGTH_SHORT).show();
                    }else if (TextUtils.isEmpty(TicketAmt)){
                        Toast.makeText(AttendancePublicActivity.this, "Enter Ticket Amount", Toast.LENGTH_SHORT).show();
                    }else if (TextUtils.isEmpty(b64_img)){
                        Toast.makeText(AttendancePublicActivity.this, "Click Ticket Image", Toast.LENGTH_SHORT).show();
                    }else {
                        pd.show();
                        submit.setEnabled(false);
                        submit.setClickable(false);
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://www.arunodyafeeds.com/sales/android/PublicTransportCheckout.php",
                                new Response.Listener<String>() {
                                    @Override
                                    public void onResponse(String response) {
                                        if (db.addTrackingDetail(uniqueNumber, employee.getName(), "3", Latitude.getText().toString().trim(), Longitude.getText().toString().trim(), currentDate, currentTime, 0)) {

                                            StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://www.arunodyafeeds.com/sales/android/PublicTravelDetails.php",
                                                    new Response.Listener<String>() {
                                                        @Override
                                                        public void onResponse(String response) {
                                                            Log.i("PublicTravelResponse",response);
                                                ...
                                                protected Map<String, String> getParams() throws AuthFailureError {
                                                    ...
                                                    map.put("ticketImg", b64_img);
                                                    map.put("amount", TicketAmt);
        ...
        if (cameraIntent.resolveActivity(getPackageManager()) != null) {
            ...
            try {
                ...
                if(ex.getMessage().equalsIgnoreCase("Permission denied")){
                    ...
                    Toast.makeText(AttendancePublicActivity.this,ex.getMessage(),Toast.LENGTH_LONG).show();
                }
            }
            if (photoFile != null) {
    ...
    private void buildAlertMessageNoGps() {
        ...
        Task<LocationSettingsResponse> result = LocationServices.getSettingsClient(AttendancePublicActivity.this).checkLocationSettings(builder.build());
                    ...
                    switch (e.getStatusCode()){
                        case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                            try {
                                ...
                                resolvableApiException.startResolutionForResult(AttendancePublicActivity.this,REQUEST_GPS_CODE);
    ...
    private void MyCurrentLocation() {
        ...
        if(ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED){
            ...
            ActivityCompat.requestPermissions(AttendancePublicActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},44);
        }
    }
