...
public class LocationUpdatesService extends Service {
    ...
    private List<OfflineTracking> offlineTrackings;
    ...
    //2min = 120000 //5min = 300000    //10min = 600000     //15min = 900000    //20min = 1200000   //30min = 1800000
    ...
    private String currentDate="",currentTime="",uniqueNumber;
    Employee employee;

    BroadcastReceiver brTime;
    ...
    public void onCreate() {
        ...
        offlineTrackings = new ArrayList<>();
...
//    };
    ...
    public IBinder onBind(Intent intent) {
        ...
        // Register db when service will restart
        return mBinder;
    }
    ...
    private Notification getNotification() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.app_logo, getString(R.string.launch_activity), activityPendingIntent)
                .setContentText(text)
    ...
    private void saveNameToServer(String type) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://www.arunodyafeeds.com/sales/android/Tracking.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.i("LocationUpdateResponce",response);
                        try {
                            JSONObject obj = new JSONObject(response);
                            if (!obj.getBoolean("error")) {
                                //if there is a success
                                //storing the name to sqlite with status synced
                                Log.i("LocationError","NoError");
                                saveNameToLocalStorage(uniqueNumber, employee.getName(), type, String.valueOf(latitude), String.valueOf(longitude), currentDate, currentTime, 1);
                            } else {
                                //if there is some error
                                //saving the name to sqlite with status unsynced
                                Log.i("LocationError","Error");
                                saveNameToLocalStorage(uniqueNumber, employee.getName(), type, String.valueOf(latitude), String.valueOf(longitude), currentDate, currentTime, 0);
                            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                hashMap.put("employeeName",employee.getName());
    ...
    private void saveNameToLocalStorage(String uniquenumber,String employeeName,String type,String latitude,String longitude,String date, String time, int status) {
        db.addTrackingDetail(uniquenumber, employeeName, type, latitude, longitude, date, time, status);
        OfflineTracking n = new OfflineTracking(uniquenumber, employeeName, type, latitude, longitude, date, time, status);
        offlineTrackings.add(n);
    }
    ...
    private void SavetoServer(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://www.arunodyafeeds.com/sales/android/Tracking.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("resMM", "Send to server");
                        Log.i("LocationResponce", String.valueOf(response));
                    }
                }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                error.getStackTrace();
                Log.i("LocationResponce", String.valueOf(error.getMessage()));
            }
        }){
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
        ...
        RequestQueue rQeue= Volley.newRequestQueue(LocationUpdatesService.this);
        rQeue.add(request);
    }
}
